          ...
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-3">
              ...
              <Link
                ...
                className="flex items-center gap-2 bg-gradient-to-br from-emerald-500 to-cyan-500 rounded-full px-4 py-2 text-white hover:text-slate-50 font-medium transition-colors"
              >
